    ...
    public function update(Request $request, $id)
    {
        ...
        if($bank_transfer_payment && $bank_transfer_payment->status == 'Pending')
        {
            ...
            if($request->status == 'Approved')
            {
                ...
                $assignPlan= DirectAssignPlan($duration,$user_module,$user_counter,'Bank Transfer',$bank_transfer_payment->user_id);

                $plan = Plan::first();

                $user = User::find($bank_transfer_payment->user_id);
                $assignPlan = $user->assignPlan($duration,$user_module,$user_counter,$bank_transfer_payment->user_id);
