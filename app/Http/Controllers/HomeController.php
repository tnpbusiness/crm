...
class HomeController extends Controller
{
    ...
    public function Software()
    {
        ...
        return view('marketplace.software',compact('modules'));
    }
    public function SoftwareDetails($slug)
    {
        ...
        // return redirect()->back()->with('error', __('Details not found!'));
    }
    public function Pricing()
    {
        ...
        else
        {
            $plan = Plan::first();
            $modules = Module::getByStatus(1);
            return view('marketplace.pricing',compact('modules','plan'));
        }
    }
}
