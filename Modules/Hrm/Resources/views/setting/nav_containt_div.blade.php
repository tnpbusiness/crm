            ...
            <div class="card">
                ...
                <div class="card-body table-border-style ">
                    ...
                    <div class="form-group col-12">
                        ...
                        <textarea name="offer_content" class="pc-tinymce-2" id="offer_content">{!! isset($currOfferletterLang->content) ? $currOfferletterLang->content : '' !!}</textarea>
                    </div>
                    <div class="card-footer text-end">
        ...
        <div class="card">
            ...
            <div class="card-body table-border-style ">
                ...
                <div class="form-group col-12">
                    ...
                    <textarea name="joining_content" class="pc-tinymce-2" id="joining_content" >{!! isset($currjoiningletterLang->content) ? $currjoiningletterLang->content : '' !!}</textarea>
                </div>
                <div class="card-footer text-end">
                    {{ Form::submit(__('Save Changes'), ['class' => 'btn  btn-primary']) }}
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body table-border-style ">
                ...
                <div class="form-group col-12">
                    ...
                    <textarea name="experience_content" class="pc-tinymce-2" id="experience_content">{!! isset($curr_exp_cetificate_Lang->content) ? $curr_exp_cetificate_Lang->content : '' !!}</textarea>
        ...
        <div class="card">
            ...
            <div class="card-body table-border-style ">
                ...
                <div class="form-group col-12">
                    ...
                    <textarea name="noc_content" class="pc-tinymce-2" id="noc_content">{!! isset($currnocLang->content) ? $currnocLang->content : '' !!}</textarea>
