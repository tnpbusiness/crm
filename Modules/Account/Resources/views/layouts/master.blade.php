...
<title>@yield('page-title') | {{ !empty(company_setting('title_text',$company_id)) ? company_setting('title_text',$company_id) : (!empty(admin_setting('title_text')) ? admin_setting('title_text') :'WorkDo') }}</title>
