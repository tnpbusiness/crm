            ...
            <div class="row justify-content-between align-items-center ">
                <div class="col-12 d-flex align-items-center justify-content-between justify-content-md-end">
                    ...
                    <div class="all-button-box mr-3">
                        <a href="{{ route('bill.resent', $bill->id) }}" class="btn btn-sm btn-success">
                            {{ __('Resend Bill') }}
                        </a>
                        <a href="{{ route('bill.pdf', Crypt::encrypt($bill->id)) }}" target="_blank"
                            class="btn btn-sm btn-success"><i class="ti ti-printer"></i>
                            {{ __('Print') }}
                        </a>
                    </div>
                </div>
                                        ...
                                        <table class="table  mb-0">
                                            ...
                                            @foreach ($iteams as $key => $iteam)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        {{ currency_format_with_sym($iteam->price * $iteam->quantity - $iteam->discount + $totalTaxPrice, $company_id, $workspace_id) }}
                                                    </td>
                                                </tr>
                                            @endforeach
                                            <tfoot>
