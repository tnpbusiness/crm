...
class VenderController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (Auth::user()->can('vendor create'))
        {
            ...
            //slack
            if(module_is_active('Slack') && !empty(company_setting('New Vendor')) && company_setting('New Vendor')  == true)
            {
            ...
            //telegram
            if(module_is_active('Telegram') && !empty(company_setting('Telegram New Vendor')) && company_setting('Telegram New Vendor')  == true)
            {
                $msg = __("New Vendor created by").' '.\Auth::user()->name.'.';
                // SendTelegramMsg
            ...
            //twilio
            if(module_is_active('Twilio') && !empty(company_setting('Twilio New Vendor')) && company_setting('Twilio New Vendor')  == true)
            {
            ...
            if(module_is_active('Webhook')){
                ...
                $action = 'New Vendor';
                $module = 'Account';
                event(new \Modules\Webhook\Events\SendWebhook($module ,$vendor,$action));
            }
