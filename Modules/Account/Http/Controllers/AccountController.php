    ...
    public function index()
    {
        if(Auth::check())
        {
            if (Auth::user()->can('account dashboard manage'))
            {
                ...
                {
                    $incomeCategory = \Modules\ProductService\Entities\Category::where('workspace_id', '=', getActiveWorkSpace())->where('type', '=', 1)->get();
                    ...
                    $expenseCategory = \Modules\ProductService\Entities\Category::where('workspace_id', '=', getActiveWorkSpace())->where('type', '=', 2)->get();
                ...
                if(module_is_active('ProductService'))
                {
                    ...
                    $constant['category']      = \Modules\ProductService\Entities\Category::where('workspace_id', getActiveWorkSpace())->count();
