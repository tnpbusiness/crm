...
class CustomerController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (Auth::user()->can('customer create'))
        {
            ...
            //slack
            if(module_is_active('Slack') && !empty(company_setting('New Customer')) && company_setting('New Customer')  == true)
            {
            ...
            //telegram
            if(module_is_active('Telegram') && !empty(company_setting('Telegram New Customer')) && company_setting('Telegram New Customer')  == true)
            {
                $msg = __("New Customer created by").' '.\Auth::user()->name.'.';
                // SendTelegramMsg
            ...
            //twilio
            if(module_is_active('Twilio') && !empty(company_setting('Twilio New Customer')) && company_setting('Twilio New Customer')  == true)
            {
                if(!empty($request->contact)){
                    $msg = __("New Customer created by").' '.\Auth::user()->name.'.';
                    event(new \Modules\Twilio\Events\SendTwilioMsg($request->contact,$msg));
                }
            }
            //webhook
            if(module_is_active('Webhook')){
                ...
                $action = 'New Customer';
                $module = 'Account';
                event(new \Modules\Webhook\Events\SendWebhook($module ,$customer,$action));
            }
