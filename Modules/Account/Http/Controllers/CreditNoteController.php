...
class CreditNoteController extends Controller
{
    ...
    public function store(Request $request, $invoice_id)
    {
        if(Auth::user()->can('creditnote create'))
        {
            ...
            AccountUtility::userBalance('customer', $invoice->customer_id, $request->amount, 'debit');
    ...
    public function update(Request $request, $invoice_id, $creditNote_id)
    {
        if(Auth::user()->can('creditnote edit'))
        {
            ...
            AccountUtility::userBalance('customer', $invoiceDue->customer_id, $credit->amount, 'credit');
            $credit->date        = $request->date;
            $credit->amount      = $request->amount;
            $credit->description = $request->description;
            $credit->save();
            AccountUtility::userBalance('customer', $invoiceDue->customer_id, $request->amount, 'debit');
    ...
    public function destroy($invoice_id, $creditNote_id)
    {
        if(Auth::user()->can('creditnote delete'))
        {
            ...
            Invoice::userBalance('customer', $creditNote->customer, $creditNote->amount, 'credit');
