...
class Purchase extends Model
{
    ...
    public static function addWarehouseStock($product_id, $quantity, $warehouse_id)
    {
        ...
        $product_quantity = \DB::table('purchase_products')->join('purchases', 'purchase_products.purchase_id', '=', 'purchases.id')->where('purchases.warehouse_id',$warehouse_id)->where('purchase_products.product_id',$product_id)->sum('purchase_products.quantity');
