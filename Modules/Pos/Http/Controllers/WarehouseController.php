...
class WarehouseController extends Controller
{
    ...
    public function store(Request $request)
    {
        if(\Auth::user()->can('warehouse create'))
        {
            ...
            if(module_is_active('Slack') && !empty(company_setting('New Warehouse')) && company_setting('New Warehouse')  == true)
            {
                $msg = 'New Warehouse' . " created by " . \Auth::user()->name . '.';
                event(new \Modules\Slack\Events\SendSlackMsg($msg));
            }
            if(module_is_active('Telegram') && !empty(company_setting('Telegram New Warehouse')) && company_setting('Telegram New Warehouse')  == true)
            {
                $msg = 'New Warehouse' . " created by " . \Auth::user()->name . '.';
                // SendTelegramMsg
            ...
            if(module_is_active('Webhook')){
                ...
                $module = 'Pos';
                event(new \Modules\Webhook\Events\SendWebhook($module ,$warehouse,$action));
            }
