            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('Get an overview of the total number of projects, tasks, bugs, and members. A visual representation of the task overview and project status can help you estimate the progress on each task. Lastly, you can check the top due task.')}}</p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('ONE TOOL TO MANAGE ALL YOUR PROJECTS AND PEOPLE')}}</h2>
            ...
            <div class="row row-gap padding-bottom ">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Feasibility in finding tasks and projects with a search tab on the top')}}</h2>
                        </div>
                        ...
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Collaborate With Anyone, Anywhere.')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Easily assign tasks, projects, and milestones to team members. Chat with your team in real-time, exchange files, and brainstorm ideas. Invite clients to discuss projects and deliver results.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
            ...
            <div class="row row-gap  padding-bottom">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Creating milestones and assigning subtasks')}}</h2>
                        </div>
                        ...
                        <div class="theme-acnav">
                            ...
                            <div class="set has-children">
                                ...
                                <div class="acnav-list">
                                    <p>{{__('Get a better visual overview of all your projects, tasks, and assigned team members. Boost team productivity. ')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row row-gap align-items-center padding-bottom">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Project Task Prioritization and Commenting')}}</h2>
                        </div>
                        <p>{{__('Prioritize tasks to ensure that you and your team members always focus on the most important task in the pipeline. Leave relevant comments, ask questions, and get answers right on the task or project. ')}}</p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
            ...
            <div class="row row-gap align-items-center ">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Manage Your Clients With Ease')}}</h2>
                        </div>
                        <p> {{__('Manage your clients’ details, collaborate with them, discuss projects, and help them watch your progress. Make it easy for them to pay you for your work.')}}</p>
                    </div>
                </div>
            </div>
        </div>
