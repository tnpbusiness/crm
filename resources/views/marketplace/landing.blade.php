            ...
            <div class="row align-items-start justify-content-center ">
                <div class="col-lg-4 col-md-6 col-12 support-card">
                    <div class="support-card-inner">
                        ...
                        <div class="support-content">
                            ...
                            <p>{{ __('Give your customers a quick way to find the products they want. Thanks to a built-in,
                ...
                <div class="col-lg-4 col-md-6 col-12 support-card">
                    <div class="support-card-inner">
                        ...
                        <div class="support-content">
                            <h3>{{ ('Guaranteed to Grow Your Business')}}</h3>
                            <p>{{ __('Give your customers a quick way to find the products they want. Thanks to a built-in,
                                intuitive search and filtering, they can view only those products that they’re
                                interested in.')}}</p>
                        </div>
            ...
            <div class="review-slider">
                <div class="review-content-itm">
                    <div class="review-content">
                        ...
                        <p> {{ __('gives your business an unfair advantage. The package doesn’t just provide you with
                            everything
                ...
                <div class="col-lg-4 col-md-6 col-12 information-card">
                    <div class="information-card-inner">
                        ...
                        <div class="information-content">
                            ...
                            <p>{{ __('Unlike many frameworks that come and go, the framework stood the test of time.
                ...
                <div class="col-lg-4 col-md-6 col-12 information-card">
                    <div class="information-card-inner">
                        ...
                        <div class="information-content">
                            ...
                            <p> {{ __("Some frameworks come and go - but Laravel is here to stay. Laravel's active developer
                ...
                <div class="col-lg-4 col-md-6 col-12 information-card">
                    <div class="information-card-inner">
                        ...
                        <div class="information-content">
                            ...
                            <p>{{ __("As you grow, you may want to expand your store with new functionalities or payment
    ...
    <section class="built-technology">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p>{{ __('Our backend is built with Laravel - one of the most popular and highest-rated web
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 information-card">
                    <div class="information-card-inner">
                        ...
                        <div class="information-content">
                            ...
                            <p> {{ __('Your online store has one goal - to sell your products. Thanks to years of experience
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 information-card">
                    <div class="information-card-inner">
                        ...
                        <div class="information-content">
                            ...
                            <p>
                                {{ __('In business, you have to act fast. By choosing our Style theme package, you can get
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 information-card">
                    <div class="information-card-inner">
                        ...
                        <div class="information-content">
                            ...
                            <p>
                            {{ __('When you get a ready-made package, you avoid common design mistakes that could cost
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 information-card">
                    <div class="information-card-inner">
                        ...
                        <div class="information-content">
                            ...
                            <p>
                                {{ __('The key to success in eCommerce is to scale your store and build an audience of
    ...
    <section class="package-detail-section padding-top">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p>{{ __('Get a fashion-themed eCommerce store with a secure backend and convenient mobile app.
            ...
            <div class="description">
                <p> {{ __('An effective fashion theme should be visually appealing and easy to navigate. A good theme makes
                ...
                <p> {{ __('With the Style theme, you get all of the above - and more. The theme gives you everything you
