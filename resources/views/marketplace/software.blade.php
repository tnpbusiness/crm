                ...
                <div class="col-lg-9 col-md-7 col-12">
                    <div class="common-banner-content">
                        <div class="section-title text-center">
                            <h2>All Add-on</h2>
                            <p>Lay a solid foundation for your fashion brand. Grab a high-converting fashion theme
    ...
    <section class="product-listing-section padding-bottom">
        <div class="container">
            ...
            <div class="listing-info padding-top ">
                <p>An effective fashion theme should be visually appealing and easy to navigate. A good theme makes it easy for customers to find and buy the items they’re interested in. The theme should also be responsive so that it looks good on all devices.</p>
                <p>With the Style theme, you get all of the above - and more. The theme gives you everything you need to sell your products and keep your audience coming back for more. Easily customize the theme and adjust its design to your branding needs. Add products, polish product pages, and start growing your online business.</p>
            </div>
        </div>
    </section>
</div>
