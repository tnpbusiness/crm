                                ...
                                <div class="card">
                                    <div class="card-body package-card-inner  d-flex align-items-center">
                                        ...
                                        <div class="price text-end">
                                            <small class="text-capitalize">{{  (SubscriptionDetails()['status'] == true) ? SubscriptionDetails()['billing_type'] : '' }}</small>
                                            <ins>{{ (SubscriptionDetails()['status'] == true) ? SubscriptionDetails()['total_user'].' '.__('Users') : '' }}</ins>
                            ...
                            <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6 product-card ">
                                <div class="card active_module">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <h4 class="text-capitalize"> {{ Module_Alias_Name($purchased->getName()) }}</h4>
                                        <p class="text-muted text-sm mb-0">
                                            {{ isset($json['description']) ? $json['description'] : '' }}
                                        </p>
                                        <div class="price d-flex justify-content-between">
                                            <ins><span class="currency-type">{{ super_currency_format_with_sym(ModulePriceByName($purchased->getName())['monthly_price']) }}</span> <span class="time-lbl text-muted">{{ __('/Month') }}</span></ins>
                                            <ins><span class="currency-type">{{ super_currency_format_with_sym(ModulePriceByName($purchased->getName())['yearly_price']) }}</span> <span class="time-lbl text-muted">{{ __('/Year') }}</span></ins>
                                        </div>
                                ...
                                <div class="summery-footer">
                                    <div class="user-qty">
                                        ...
                                        <div class="qty-spinner">
                                            ...
                                            <input id="user_counter" type="number" data-cke-saved-name="quantity" name="quantity" class="quantity" step="1" value="0" min="0" max="1000">
                                    ...
                                    <div class="cart-footer-total-row bg-primary text-white rounded p-3 d-flex align-items-center justify-content-between">
                                        ...
                                        @if (admin_setting('stripe_is_on') == 'on' || admin_setting('paypal_payment_is_on') == 'on' || admin_setting('paystack_payment_is_on') == 'on'  || admin_setting('flutterwave_payment_is_on') == 'on' || admin_setting('razorpay_payment_is_on') == 'on' || admin_setting('mercado_payment_is_on') == 'on' || admin_setting('paytm_payment_is_on') == 'on' || admin_setting('mollie_payment_is_on') == 'on' || admin_setting('skrill_payment_is_on') == 'on' || admin_setting('coingate_payment_is_on') == 'on' || admin_setting('paymentwall_payment_is_on') == 'on' || admin_setting('bank_transfer_payment_is_on') == 'on' || admin_setting('yookassa_payment_is_on') == 'on' || admin_setting('paytab_payment_is_on') == 'on')
...
@push('scripts')
    ...
    <script>
        function ChangePrice(user = null, user_module_price = 0) {
            ...
            var userpricetext = userprice * user;
            var total = userpricetext + user_module_price + parseFloat(planprice);
