            ...
            <div class="col-xl-9">
                <div id="useradd-1">
                    <div class="card">
                        ...
                        <?php echo e(Form::model($userDetail, ['route' => ['edit.profile'], 'method' => 'post', 'enctype' => 'multipart/form-data'])); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="choose-files mt-3">
                                            <label for="avatar">
                                                ...
                                                <input type="file" class="form-control" name="profile" id="avatar" data-filename="avatar-logo">
                                            </label>
                                        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jieff/Documents/codecanyon-45919116-workdo-dash-saas-open-source-erp-with-multiworkspace/codecanyon-45919116-workdo-dash-saas-open-source-erp-with-multiworkspace/main_file/resources/views/users/profile.blade.php ENDPATH**/ ?>