...
<div class="home-wrapper">
            ...
            <div class="row row-gap align-items-center">
                <div class="col-md-6 col-12">
                    <div class="banner-content">
                        <h1><?php echo e(__('With Dash, you can take care of each need of your business functions in.')); ?><b><?php echo e(__('one place')); ?></b>
                        </h1>
                        <p><?php echo e(__('Lay a solid foundation for your brand. Grab a high-converting web powered by a secure backend coupled with an intuitive eCommerce.')); ?></p>
                        <div class="btn-group">
                ...
                <div class="col-md-6 col-12">
                    <div class="banner-image-wrapper">
                        ...
                        <div class="banner-img-wrapper">
                            ...
                            <img src="<?php echo e(asset('market_assets/images/images1.png')); ?>" alt="" class="inner-frame-img">
                       </div>
                    </div>
                </div>
            </div>
        ...
        <div class="exclusive-partners">
            <div class="container">
                <div class="section-title">
                    <p><?php echo e(__('Our best partners and +11,000 customers worldwide satisfied with our services.')); ?></p>
                </div>
                <div class="partners-logo-slider">
                    <?php for($i = 1; $i < 15; $i++): ?>
                        <div class="logo-item">
                            <a href="#">
                                <img src="<?php echo e(asset('market_assets/images/logo-dark.png')); ?>" alt="exclusive partner">
                            </a>
                        </div>
                    <?php endfor; ?>
                </div>
            ...
            <div class="row align-items-start justify-content-center ">
                <div class="col-lg-4 col-md-6 col-12 support-card">
                    <div class="support-card-inner">
                        ...
                        <div class="support-content">
                            <h3><?php echo e(__('Free')); ?> <br> <?php echo e(__('& Open Source')); ?></h3>
                            <p><?php echo e(__('Give your customers a quick way to find the products they want. Thanks to a built-in,
                                intuitive search and filtering, they can view only those products that they’re
                                interested in.')); ?></p>
                        </div>
                        <div class="support-content-bottom">
                            <a href="#" class="btn"><?php echo e(__('Find Out More')); ?> <svg xmlns="http://www.w3.org/2000/svg" width="16"
                ...
                <div class="col-lg-4 col-md-6 col-12 support-card">
                    <div class="support-card-inner">
                        ...
                        <div class="support-content">
                            <h3><?php echo e(('Guaranteed to Grow Your Business')); ?></h3>
                            <p><?php echo e(__('Give your customers a quick way to find the products they want. Thanks to a built-in,
                                intuitive search and filtering, they can view only those products that they’re
                                interested in.')); ?></p>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-12 support-card">
                    <div class="support-card-inner">
                        ...
                        <div class="support-content">
                            <h3>24/7 <br><?php echo e(__('Support')); ?></h3>
                            <p><?php echo e(__('Give your customers a quick way to find the products they want. Thanks to a built-in,
                                intuitive search and filtering, they can view only those products that they’re
                                interested in.')); ?></p>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-6 col-12">
                        <div class="dash-theme-preview">
                            <img src="<?php echo e(asset('market_assets/images/account_image1.png')); ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white padding-bottom padding-top ">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7  col-md-6 col-12">
                        <div class="dash-theme-preview">
                            <img src="<?php echo e(asset('market_assets/images/hrm_image1.png')); ?>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            ...
                            <div class="theme-acnav">
                                <div class="set has-children">
                                    ...
                                    <div class="acnav-list">
                                        <p><?php echo e(__('Create a profile for every employee, track their key information, and update the information in just a few clicks. Collect and analyze feedback about their work, including warnings and complaints issued by their managers or other employees.')); ?></p>
                                    </div>
                                </div>
                                <div class="set has-children">
                                    <a href="javascript:;" class="acnav-label">
        ...
        <div class="bg-light padding-bottom padding-top">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                ...
                                <h2><?php echo e(__('Easily manage all your projects and keep your business growing.')); ?></h2>
                            </div>
                            <p><?php echo e(__('Got a big team or working on multiple projects at once? Manage task priorities or even create additional workspaces and use the built-in permission system to separate core projects. Make your team more effective by helping them avoid confusion ensuring they always know what to focus on.')); ?></p>
                            <div class="theme-acnav">
                                <div class="set has-children">
                                    <a href="javascript:;" class="acnav-label">
                                        <span class="acnav-icon">
                                        ...
                                        <span><?php echo e(__('Kanban Task Management')); ?></span>
                                    </a>
                                    <div class="acnav-list">
                                        <p><?php echo e(__('Whether you need a simple tool to track your tasks, are a Kanban fan, want to create Gantt Charts or are looking for a convenient tool to track your projects - Taskly got you covered.')); ?></p>
                                    </div>
                                </div>
                                <div class="set has-children">
                                    <a href="javascript:;" class="acnav-label">
                                        ...
                                        <span><?php echo e(__('Creating milestones and assigning subtasks')); ?></span>
                                    </a>
                                    <div class="acnav-list">
                                        <p><?php echo e(__('Add a new task to an already existing project and prioritize them according to the need of urgency. Assign the task to team members and set a due date for task completion. Add comments to the task and create a sub-task for ease of completion. Attach necessary files in a required task.')); ?></p>
                                    </div>
                                </div>
                                <div class="set has-children">
                                    <a href="javascript:;" class="acnav-label">
                                        ...
                                        <span><?php echo e(__('Bugs Resolution')); ?></span>
                                    </a>
                                    <div class="acnav-list">
                                        <p><?php echo e(__('Create new bugs and assign users and priority to them. You can write a note in the text box for the bug description. Also, the status of each bug could be changed through an easy drop-down and Kanban drag system.')); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-7 col-md-6 col-12">
                        <div class="dash-theme-preview">
                            <img src="<?php echo e(asset('market_assets/images/taskly_image1.png')); ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white padding-bottom padding-top ">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-12">
                        <div class="dash-theme-preview">
                            <img src="<?php echo e(asset('market_assets/images/lead_image1.png')); ?>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
        ...
        <div class="bg-white padding-bottom padding-top ">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                ...
                                <h2><?php echo e(__('Ease in maintaining customer and vendor details')); ?></h2>
                            </div>
                            <p><?php echo e(__('POS allows you to create and maintain the data of each customer and vendor. You get access to all essential information through a well-maintained format.')); ?></p>
                            <div class="theme-acnav">
                                <div class="set has-children">
                                    <a href="javascript:;" class="acnav-label">
                                        <span class="acnav-icon">
                                        ...
                                        <span><?php echo e(__('Manage vital information from one dashboard')); ?></span>
                                    </a>
                                    <div class="acnav-list">
                                        <p><?php echo e(__('Stay on top of your total and monthly purchases and sales. Get an interactive purchase and sales report graph to help you make informed decisions. Get progress reports of each branch, along with to-do lists and event calendars.')); ?></p>
                                    </div>
                                </div>
                                <div class="set has-children">
                                    <a href="javascript:;" class="acnav-label">
                                        ...
                                        <span><?php echo e(__('Set your sales targets and achieve them faster')); ?></span>
                                    </a>
                                    <div class="acnav-list">
                                        <p><?php echo e(__('Create sales targets and keep track of their progress in your dashboard. Use the expense list to cut down on unnecessary expenses, and put more resources into reaching your sales targets.')); ?></p>
                                    </div>
                                </div>
                                <div class="set has-children">
                                    <a href="javascript:;" class="acnav-label">
                                        ...
                                        <span><?php echo e(__('Manage your products with ease')); ?></span>
                                    </a>
                                    <div class="acnav-list">
                                        <p><?php echo e(__('Never stress about managing your inventory ever again! With PosGo, you can create your products and assign them a brand, category, unit and tax rate. You can even modify product descriptions, images, and price whenever you want.')); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-7 col-md-6 col-12">
                        <div class="dash-theme-preview">
                            <img src="<?php echo e(asset('market_assets/images/pos_image1.png')); ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="review-slider">
                <div class="review-content-itm">
                    <div class="review-content">
                        ...
                        <p> <?php echo e(__('gives your business an unfair advantage. The package doesn’t just provide you with
                            everything
        ...
        <div class="container">
            <div class="section-title text-center">
                ...
                <div class="btn-group">
                    ...
                    <a href="#" class="link-btn"><?php echo e(__('View Live Demo')); ?> <svg xmlns="http://www.w3.org/2000/svg" width="20"
            ...
            <div class="row row-gap justify-content-center ">
                <div class="col-lg-4 col-md-6 col-12 information-card">
                    <div class="information-card-inner">
                        ...
                        <div class="information-content">
                            <h5><?php echo e(__('High-Performing,')); ?><br><?php echo e(__('Secure PHP Framework')); ?></h5>
                            <p><?php echo e(__('Unlike many frameworks that come and go, the framework stood the test of time.
                                Over the years, it grew to become one of the fastest and most secure frameworks in
                                the market.')); ?></p>
                            <a href="#" class="btn btn-white" tabindex="0"><?php echo e(__('Find Out More')); ?> <svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                                    fill="none">
                                    <g clip-path="url(#clip0_14_726)">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="col-lg-4 col-md-6 col-12 information-card">
                    <div class="information-card-inner">
                        ...
                        <div class="information-content">
                            <h5><?php echo e(__('Stable Codebase')); ?></h5>
                            <p> <?php echo e(__("Some frameworks come and go - but Laravel is here to stay. Laravel's active developer
                                community helps keep its codebase up-to-date and stable. This, in turn, helps ensure
                                the stability of your eCommerce website.")); ?> </p>
                            <a href="#" class="btn btn-white" tabindex="0"><?php echo e(__('Find Out More')); ?> <svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                                    fill="none">
                                    <g clip-path="url(#clip0_14_726)">
                ...
                <div class="col-lg-4 col-md-6 col-12 information-card">
                    <div class="information-card-inner">
                        ...
                        <div class="information-content">
                            <h5><?php echo e(__('Secure Integrations')); ?></h5>
                            <p><?php echo e(__("As you grow, you may want to expand your store with new functionalities or payment
                                methods. Thanks to Laravel's flexibility,
                                it’s easy to add new integrations and customize the store even once it's already
                                developed.")); ?></p>
                            <a href="#" class="btn btn-white" tabindex="0"><?php echo e(__('Find Out More')); ?><svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                                    fill="none">
    ...
    <section class="built-technology">
        <div class="container">
            <div class="section-title text-center">
                <h2><?php echo e(__('Built with Technology')); ?> <br><b><?php echo e(__('You Can Trust')); ?></b></h2>
                <p><?php echo e(__('Our backend is built with Laravel - one of the most popular and highest-rated web
                    development frameworks. Find out why we chose it - and how it benefits your business.')); ?></p>
            </div>
            <div class="row row-gap justify-content-center">
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 information-card">
                    <div class="information-card-inner">
                        ...
                        <div class="information-content">
                            <h5><?php echo e(__('Sell More Than Your Competitors')); ?></h5>
                            <p> <?php echo e(__('Your online store has one goal - to sell your products. Thanks to years of experience
                                in the industry, we know the ins and outs of online sales. And we put that knowledge
                                into every package that we offer.
                                With the Style eCommerce package, you get a store that’s optimized for helping you
                                sell more in the fashion niche.')); ?> </p>
                            <a href="#" class="btn btn-white" tabindex="0"><?php echo e(__('Find Out More')); ?> <svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                                    fill="none">
                                    <g clip-path="url(#clip0_14_726)">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 information-card">
                    <div class="information-card-inner">
                        ...
                        <div class="information-content">
                            <h5><?php echo e(__('Get a Headstart over Your Competitors')); ?></h5>
                            <p>
                                <?php echo e(__('In business, you have to act fast. By choosing our Style theme package, you can get
                                everything you need to start selling right away.
                                Hit the market with your product sooner, attract early sales, and build an audience
                                from day one.')); ?>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 information-card">
                    <div class="information-card-inner">
                        ...
                        <div class="information-content">
                            <h5><?php echo e(__('Avoid Design Mistakes')); ?></h5>
                            <p>
                            <?php echo e(__('When you get a ready-made package, you avoid common design mistakes that could cost
                            your business a fortune. Not only that. Thanks to a higher conversion rate, you can
                            achieve better ROI on your marketing expenses.')); ?>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 information-card">
                    <div class="information-card-inner">
                        ...
                        <div class="information-content">
                            <h5><?php echo e(__('Build a Long-Term Asset')); ?></h5>
                            <p>
                                <?php echo e(__('The key to success in eCommerce is to scale your store and build an audience of
                                loyal, recurring customers. With our package, you get more than just a store. You
                                get an asset that’s ready for you to take care of it and grow it for years to come.')); ?>
    ...
    <section class="package-detail-section padding-top">
        <div class="container">
            <div class="section-title text-center">
                <h2><?php echo e(__('Start an Online Fashion Business')); ?> <b> <?php echo e(__('with a Complete eCommerce Package')); ?> </b></h2>
                <p><?php echo e(__('Get a fashion-themed eCommerce store with a secure backend and convenient mobile app.
                    Build a brand, manage your store wherever you are, and grow an online business.')); ?></p>
                <div class="btn-group">
                    <a href="<?php echo e(route('apps.pricing')); ?>" class="btn-secondary"><?php echo e(__('Get the Package')); ?> <svg xmlns="http://www.w3.org/2000/svg"
                            width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <g clip-path="url(#clip0_14_726)">
            ...
            <div class="description">
                <p> <?php echo e(__('An effective fashion theme should be visually appealing and easy to navigate. A good theme makes
                    it easy for customers to find and buy the items they’re interested in. The theme should also be
                    responsive so that it looks good on all devices.')); ?> </p>
                <p> <?php echo e(__('With the Style theme, you get all of the above - and more. The theme gives you everything you
                    need to sell your products and keep your audience coming back for more. Easily customize the
                    theme and adjust its design to your branding needs. Add products, polish product pages, and
                    start growing your online business.')); ?> </p>
            </div>
        </div>
    </section>
</div>
